...
@test writeTopologyLevel1(net) == "(Adif:1.0,(Aech:0.122,(Asub:1.0,Agem:1.0):10.0):10.0,Aten:2.614);"
 #"deleteHybridEdge! didn't work on 10th edge"
net = readTopology("((Adif:1.0,(Aech:0.122,#H6:10.0::0.047):10.0):1.614,Aten:1.0,((Asub:1.0,Agem:1.0):0.0)#H6:5.062::0.953);");
deleteHybridEdge!(net, net.edge[3]);
@test writeTopologyLevel1(net) == "((Adif:1.0,Aech:10.122):1.614,Aten:1.0,(Asub:1.0,Agem:1.0):5.062);"
 #"deleteHybridEdge! didn't work on 3rd edge"
# plot(net, showEdgeNumber=true, showNodeNumber=true)

net=readTopology("(4,((1,(2)#H7:::0.864):2.069,(6,5):3.423):0.265,(3,#H7:::0.1361111):10.0);");
# plot(net, showEdgeNumber=true, showNodeNumber=true)
deleteHybridEdge!(net, net.edge[11]);
@test writeTopologyLevel1(net) == "(4,((1,2):2.069,(6,5):3.423):0.265,3);"
 #"deleteHybridEdge! didn't work on 11th edge"
net=readTopology("(4,((1,(2)#H7:::0.864):2.069,(6,5):3.423):0.265,(3,#H7:::0.1361111):10.0);");
deleteHybridEdge!(net, net.edge[4]);
@test writeTopologyLevel1(net) == "(4,((6,5):3.423,1):0.265,(3,2):10.0);"
 #"deleteHybridEdge! didn't work on 4th edge"
end
...
deleteHybridEdge!(net, net.edge[4]);
@test writeTopologyLevel1(net) == "(4,((6,5):3.423,1):0.265,(3,2):10.0);"
 #"deleteHybridEdge! didn't work on 4th edge when isChild1 was outdated"
...
@test writeTopologyLevel1(net) == "(Adif:1.0,(Aech:0.122,(Asub:1.0,Agem:1.0):10.0):10.0,Aten:2.614);"
 #"deleteHybridEdge! didn't work on 10th edge after isChild1 was changed"
# plot(net, showEdgeNumber=true, showNodeNumber=true)
end
...
end # of testset displayedNetworks! and displayedTrees
...
end # of testset majorTree and displayedNetworkAt!
...
@testset "Testing displayedTrees, hardwiredClusters, hardwiredClusterDistance, displayedNetworkAt!" begin
